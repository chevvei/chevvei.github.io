    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          var liTmpl = "";
          for (var i = 0, len = data.link.length; i < lengithub; i++) {
          
            // var minSrc = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/min_photos/' + data.link[i];
            //var minSrc = 'https://raw.githubusercontent.com/chevvei/Blog_Album/Blob/master/min_photos/' + data.link[i];
            //var minSrc = 'https://github.com/chevvei/Blog_Album/tree/master/min_photos/' + data.link[i];
            var minSrc = 'https://raw.githubusercontent.com/chevvei/Blog_Album/master/min_photos/' + data.link[i];
            
			
           // var src = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/photos/' + data.link[i];
           // var src = 'https://raw.githubusercontent.com/chevvei/Blog_Album/Blob/master/photos' + data.link[i];
           //var src = 'https://github.com/chevvei/Blog_Album/tree/master/photos/' + data.link[i];
           var minSrc = 'https://raw.githubusercontent.com/chevvei/Blog_Album/master/photos/' + data.link[i];
